    ...
    <header class="header-main-page">
                        ...
                        <div class="col-lg-8 col-md-12 col-xs-12 pull-right">
                            <div class="search-header search-box">
                                <form action="#">
                                    ...
                                    <button class="btn-search" type="submit"><img src="{{ asset('site/images/search.png') }}"
                                            alt="search"></button>
                                </form>
                                <div class="search-result">
                                    ...
                                    <div class="search-results-list js-search-ad-banner">
                                        <a href="#">
                                            <img src="{{ asset('site/images/banner-search.png') }}" alt="banner-search">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="force-overflow">
                                            <ul class="header-basket-list">
                                                <li class="js-mini-cart-item">
                                                    <a href="#" class="header-basket-list-item">
                                                        <div class="header-basket-list-item-image">
                                                            <img src="{{ asset('site/images/product-slider-2/GalaxyS20Ultra.png') }}"
                                                                alt="img-slider">
                                                        </div>
                                                ...
                                                <li class="js-mini-cart-item">
                                                    <a href="#" class="header-basket-list-item">
                                                        <div class="header-basket-list-item-image">
                                                            <img src="{{ asset('site/images/product-slider-2/Huawei-WATCHFIT.png') }}"
                                                                alt="img-slider">
                                                        </div>
                                                        <div class="header-basket-list-item-content">
                                                ...
                                                <li class="js-mini-cart-item">
                                                    <a href="#" class="header-basket-list-item">
                                                        <div class="header-basket-list-item-image">
                                                            <img src="{{ asset('site/images/product-slider-2/NIGHT-HUNTER.png') }}"
                                                                alt="img-slider">
                                                        </div>
                                                        <div class="header-basket-list-item-content">
                                    ...
                                    <div class="header-profile-dropdown-account">
                                        <div class="header-profile-dropdown-user">
                                            <div class="header-profile-dropdown-user-img">
                                                <img src="{{ asset('site/images/svg/user-profile.png') }}" alt="profile">
                                            </div>
                    ...
                    <li class="item-list-menu megamenu-1 nav-overlay"><a href="#" class="list-category first after"
                        ...
                        <ul class="list-menu-level-2 list-menu-discounts-offers">
                            ...
                            <li class="discounts-offers-list-item main-banner">
                                <a href="#">
                                    <img src="{{ asset('site/images/banner.png') }}" alt="banner">
                                </a>
                            </li>
                        </ul>
                    </li>
        ...
        <nav class="sidebar">
            <div class="nav-header">
                ...
                <div class="logo-wrap">
                    <a class="logo-icon" href="#"><img alt="logo-icon" src="{{ asset('site/images/logo.png') }}" width="40"></a>
                </div>
            </div>
